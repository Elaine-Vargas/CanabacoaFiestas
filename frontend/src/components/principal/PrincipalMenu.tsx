...
const PrincipalMenu: React.FC = React.memo(() => (
  ...
  <header className="principalHeader">
    <div className="principalContent">
      ...
      <Link to="/Login" className="principalButton">INGRESAR</Link>
    </div>
    <div className="principalInfo">
      <p className="principalPhrase">¡Transformamos tus eventos en experiencias inolvidables!</p>
      <p>
        En Canabacoa Fiestas, nos especializamos en hacer realidad tus sueños para cualquier ocasión especial.
        Ofrecemos alquiler de mobiliario, decoración personalizada y detalles únicos que se adaptan a tu estilo y temática.
      </p>
    </div>
  </header>
  </>
