...
import DetalleSupervision from './DetalleSupervision';
  ...
  @Column({
    ...
    validate: {
      is: {
        ...
        msg: 'Formato de usuario inválido: debe comenzar con letra, terminar con alfanumérico y tener entre 5-25 caracteres'
      }
    }
  })
