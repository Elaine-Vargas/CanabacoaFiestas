...
exports.ReporteUsuariosPorRolYEstado = void 0;
...
const ReporteUsuariosPorRolYEstado = async (req, res) => {
    try {
        ...
        const usuarios = await Usuario_model_1.default.findAll({
            where: whereClause,
            include: [Rol_model_1.default],
            order: [['nombre_usuario', 'ASC']]
        });
        if (!usuarios || usuarios.length === 0) {
            let rolNombre = 'seleccionado';
            if (id_rol !== 'todos') {
                const rol = await Rol_model_1.default.findByPk(id_rol);
...
exports.ReporteUsuariosPorRolYEstado = ReporteUsuariosPorRolYEstado;
