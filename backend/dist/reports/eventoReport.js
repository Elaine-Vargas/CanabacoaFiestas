...
exports.generarReporteEquipos = exports.generarReporteEventosPersonal = exports.generarReporteEventosAsesor = exports.generarReporteEventosCliente = exports.generarReporteEventos = void 0;
...
const generarReporteEventos = async (req, res) => {
    try {
        ...
        if (!eventos || eventos.length === 0) {
            ...
            if (tipo_evento && tipo_evento !== 'todos' && tipo_evento !== '') {
                const tipoEventoInfo = await TipoEvento_model_1.default.findByPk(Number(tipo_evento));
...
exports.generarReporteEventos = generarReporteEventos;
const generarReporteEventosCliente = async (req, res) => {
    try {
        ...
        if (cedula_cliente !== 'todos') {
            clienteInfo = await Usuario_model_1.default.findOne({
        ...
        const eventos = await Evento_model_1.default.findAll({
            ...
            include: [
                { model: Usuario_model_1.default, as: 'cliente', attributes: ['nombre_usuario', 'apellido_usuario', 'cedula_usuario'] },
                { model: Usuario_model_1.default, as: 'asesor', attributes: ['nombre_usuario', 'apellido_usuario', 'cedula_usuario'] },
                { model: TipoEvento_model_1.default, attributes: ['tipo_evento'] }
            ],
            order: [['fecha_evento', 'DESC']]
        });
        if (!eventos || eventos.length === 0) {
        ...
        const drawRow = (yPos, values, bold = false) => {
            const font = bold ? 'Helvetica-Bold' : 'Helvetica';
            doc.font(font).fontSize(10);
            let x = startX;
            values.forEach((text, i) => {
...
exports.generarReporteEventosCliente = generarReporteEventosCliente;
const generarReporteEventosAsesor = async (req, res) => {
    try {
        ...
        if (cedula_asesor !== 'todos') {
            asesorInfo = await Usuario_model_1.default.findOne({
...
exports.generarReporteEventosAsesor = generarReporteEventosAsesor;
const generarReporteEventosPersonal = async (req, res) => {
    try {
        ...
        if (id_personal !== 'todos') {
            personalInfo = await Usuario_model_1.default.findOne({
        ...
        const eventos = await Evento_model_1.default.findAll({
            ...
            include: [
                ...
                { model: TipoEvento_model_1.default, attributes: ['tipo_evento'] },
                {
                    model: EmpleadoEvento_model_1.default,
                    as: 'empleados_evento',
...
exports.generarReporteEventosPersonal = generarReporteEventosPersonal;
const generarReporteEquipos = async (req, res) => {
    try {
        const { cedula_asesor } = req.params;
        const { evento_id, empleado_id, puesto } = req.query;
        // Verificar si el asesor existe si se especificó uno
        if (cedula_asesor) {
            const asesor = await Usuario_model_1.default.findOne({
                where: {
        ...
        if (empleado_id && empleado_id !== 'todos') {
            ...
            const asignacionesEmpleado = await EmpleadoEvento_model_1.default.findAll({
                where: {
        ...
        if (evento_id && evento_id !== 'todos') {
            const evento = await Evento_model_1.default.findByPk(Number(evento_id));
            if (!evento) {
                return res.status(404).json({
        ...
        const empleadosEventos = await EmpleadoEvento_model_1.default.findAll({
            where: whereClause,
...
exports.generarReporteEquipos = generarReporteEquipos;
