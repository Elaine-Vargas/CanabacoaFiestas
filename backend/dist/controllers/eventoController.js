...
exports.getEmpleadosByClienteEventos = exports.updateEventStatus = exports.updateEmployeeAssignmentStatus = exports.removeEmployeeFromEvent = exports.updateEmployeeRole = exports.getAsesorTeamAssignments = exports.getEmployeeEvents = exports.getEventEmployees = exports.assignEmployeeToEvent = exports.getTiposEventos = exports.deleteEvent = exports.editEvent = exports.showEventsByAsesor = exports.showEventsByClient = exports.showEventsByStatus = exports.showAllEvents = exports.createEvent = void 0;
...
const createEvent = async (req, res) => {
    try {
        const { cedula_cliente, cedula_asesor, fecha_evento, hora_evento, id_tipo_evento, id_provincia, id_ciudad, sector, calle, detalles, espacio_evento, estado_solicitud, desea_supervision, nota_cliente } = req.body;
        console.log('Datos recibidos:', req.body);
        // Verificar roles
        const cliente = await Usuario_model_1.default.findOne({ where: { cedula_usuario: cedula_cliente, id_rol: 2 } });
        if (!cliente) {
        ...
        let asesor = null;
        if (cedula_asesor) {
            asesor = await Usuario_model_1.default.findOne({ where: { cedula_usuario: cedula_asesor, id_rol: 3 } });
            if (!asesor) {
                return res.status(400).json({
        ...
        const tipoEvento = await TipoEvento_model_1.default.findByPk(id_tipo_evento);
        if (!tipoEvento) {
            return res.status(400).json({
        ...
        const ciudad = await Ciudad_model_1.default.findOne({
            where: {
                id_ciudad,
                id_provincia
            }
        ...
        // Crear el evento
        const evento = await Evento_model_1.default.create({
            cedula_cliente,
        ...
        const eventoCompleto = await Evento_model_1.default.findByPk(evento.id_evento, {
            include: [
                {
...
const showEventsByStatus = async (req, res) => {
    try {
        const { estado } = req.params;
        const eventos = await Evento_model_1.default.findAll({
            where: { estado_solicitud: estado },
            include: [
                { model: Usuario_model_1.default, as: 'cliente' }, // Asegúrate que este es el alias correcto
                { model: Usuario_model_1.default, as: 'asesor' }, // Asegúrate que este es el alias correcto
                { model: TipoEvento_model_1.default, as: 'tipo_evento' } // Asegúrate que este es el alias correcto
            ]
        });
        if (!eventos || eventos.length === 0) {
            return res.status(404).json({
...
exports.showEventsByStatus = showEventsByStatus;
const showEventsByClient = async (req, res) => {
    try {
...
exports.showEventsByClient = showEventsByClient;
const showEventsByAsesor = async (req, res) => {
    try {
...
exports.showEventsByAsesor = showEventsByAsesor;
const editEvent = async (req, res) => {
    try {
        const { id_evento } = req.params;
        const { cedula_cliente, cedula_asesor, fecha_evento, hora_evento, id_direccion, espacio_evento, id_tipo_evento, desea_supervision, nota_cliente, estado_solicitud, } = req.body;
        ...
        if (cedula_asesor) {
            const asesor = await Usuario_model_1.default.findOne({ where: { cedula_usuario: cedula_asesor, id_rol: 3 } });
            if (!asesor) {
                return res.status(400).json({
                    error: 'Asesor no válido',
                    mensaje: 'El asesor no existe o no tiene el rol correcto'
...
const getTiposEventos = async (req, res) => {
    try {
        ...
        const tipoevento = await TipoEvento_model_1.default.findAll({});
...
exports.getTiposEventos = getTiposEventos;
//empleado-evento APIs
const assignEmployeeToEvent = async (req, res) => {
    try {
        ...
        const empleado = await Usuario_model_1.default.findOne({
        ...
        const existingAssignment = await EmpleadoEvento_model_1.default.findOne({
            where: {
                id_evento: id_evento,
        ...
        const empleadoEvento = await EmpleadoEvento_model_1.default.create({
            id_evento,
            empleado_evento,
            puesto_evento,
            estado_empevento: 'Activo'
...
exports.assignEmployeeToEvent = assignEmployeeToEvent;
const getEventEmployees = async (req, res) => {
    try {
        const { id_evento } = req.params;
        const empleados = await EmpleadoEvento_model_1.default.findAll({
            where: {
                id_evento,
                estado_empevento: 'Activo'
            },
            include: [
                { model: Usuario_model_1.default, as: 'empleado' } // Asegúrate que este es el alias correcto
            ]
        });
...
exports.getEventEmployees = getEventEmployees;
const getEmployeeEvents = async (req, res) => {
    try {
        ...
        const eventos = await EmpleadoEvento_model_1.default.findAll({
            where: {
            ...
            include: [
                {
                    ...
                    as: 'evento',
                    include: [
                        { model: Usuario_model_1.default, as: 'cliente', attributes: ['nombre_usuario', 'apellido_usuario'] },
                        { model: Usuario_model_1.default, as: 'asesor', attributes: ['nombre_usuario', 'apellido_usuario'] },
                        { model: TipoEvento_model_1.default, as: 'tipo_evento', attributes: ['tipo_evento'] },
                    ]
                },
                {
                    model: Usuario_model_1.default,
            ...
            order: [[{ model: Evento_model_1.default, as: 'evento' }, 'fecha_evento', 'DESC']]
        });
...
const getAsesorTeamAssignments = async (req, res) => {
    try {
...
exports.getAsesorTeamAssignments = getAsesorTeamAssignments;
const updateEmployeeRole = async (req, res) => {
    try {
        const { id_evento, empleado_evento } = req.params;
        const { puesto_evento } = req.body;
        const empleadoEvento = await EmpleadoEvento_model_1.default.findOne({
            where: {
                id_evento,
                empleado_evento,
                estado_empevento: 'Activo'
...
const removeEmployeeFromEvent = async (req, res) => {
    try {
        const { id_evento, empleado_evento } = req.params;
        const asignacion = await EmpleadoEvento_model_1.default.findOne({
            where: {
                id_evento: id_evento,
                empleado_evento: empleado_evento
            }
...
exports.removeEmployeeFromEvent = removeEmployeeFromEvent;
const updateEmployeeAssignmentStatus = async (req, res) => {
    try {
        const { id_evento, empleado_evento } = req.params;
...
exports.updateEmployeeAssignmentStatus = updateEmployeeAssignmentStatus;
...
const getEmpleadosByClienteEventos = async (req, res) => {
    try {
        const { cedula_cliente } = req.params;
        ...
        const empleadoEventoWhere = {
            id_evento: id_evento ? id_evento : { [sequelize_1.Op.in]: eventosIds }
        };
        if (estado_empevento)
            empleadoEventoWhere.estado_empevento = estado_empevento;
        if (puesto_evento)
            empleadoEventoWhere.puesto_evento = puesto_evento;
        // Buscar empleados asignados a los eventos del cliente
        const empleadosAsignados = await EmpleadoEvento_model_1.default.findAll({
...
exports.getEmpleadosByClienteEventos = getEmpleadosByClienteEventos;
