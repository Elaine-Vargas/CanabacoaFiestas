...
exports.updateUserStatus = exports.getAllRoles = exports.deleteUser = exports.updateUser = exports.searchUsers = exports.getUsersByStatus = exports.getUsersByRole = exports.getAllUsers = void 0;
const Usuario_model_1 = __importDefault(require("../models/Usuario_model"));
const sequelize_1 = require("sequelize");
const Rol_model_1 = __importDefault(require("../models/Rol_model"));
    ...
    try {
        ...
        if (estados) {
            ...
            whereClause.estado_usuario = {
                [sequelize_1.Op.in]: estadosArray
            };
        }
        // Agregar búsqueda por diferentes campos si se proporciona
        if (search) {
            whereClause[sequelize_1.Op.or] = [
                { nombre_usuario: { [sequelize_1.Op.like]: `%${search}%` } },
                { apellido_usuario: { [sequelize_1.Op.like]: `%${search}%` } },
                { cedula_usuario: { [sequelize_1.Op.like]: `%${search}%` } },
                { tel_usuario: { [sequelize_1.Op.like]: `%${search}%` } },
                { correo_usuario: { [sequelize_1.Op.like]: `%${search}%` } }
            ];
        }
...
const searchUsers = async (req, res) => {
    try {
        ...
        const usuarios = await Usuario_model_1.default.findAll({
            where: {
                [sequelize_1.Op.or]: [
                    { nombre_usuario: { [sequelize_1.Op.like]: `%${query}%` } },
                    { apellido_usuario: { [sequelize_1.Op.like]: `%${query}%` } },
                    { cedula_usuario: { [sequelize_1.Op.like]: `%${query}%` } },
                    { tel_usuario: { [sequelize_1.Op.like]: `%${query}%` } },
                    { correo_usuario: { [sequelize_1.Op.like]: `%${query}%` } }
                ]
            },
            attributes: [
                'nombre_usuario',
...
const updateUser = async (req, res) => {
    ...
    try {
        ...
        if (updateData.correo_usuario) {
            const usuarioConMismoCorreo = await Usuario_model_1.default.findOne({
                where: {
                    correo_usuario: updateData.correo_usuario,
                    cedula_usuario: { [sequelize_1.Op.ne]: cedula } // Excluir al usuario actual
                }
            });
        ...
        const usuarioActualizado = await Usuario_model_1.default.findByPk(cedula, {
...
const updateUserStatus = async (req, res) => {
    try {
        ...
        const usuario = await Usuario_model_1.default.findByPk(cedula);
        if (!usuario) {
            return res.status(404).json({
                error: 'Usuario no encontrado',
