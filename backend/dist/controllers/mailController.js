...
exports.verifyEmailCode = exports.sendWelcomeEmail = exports.resetPassword = exports.sendRecoveryEmail = exports.sendVerificationEmail = void 0;
...
const sendVerificationEmail = async (correo_usuario, verificationCode, isUpdate = false) => {
    const mailOptions = {
      ...
      <div style="font-family: 'Century Gothic', sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>${isUpdate
            ...
            : 'Gracias por registrarte. Para completar tu registro, por favor usa el siguiente código de verificación:'}</p>
...
const sendRecoveryEmail = async (req, res) => {
    ...
    try {
        ...
        const usuario = await Usuario_model_1.default.findOne({
            where: {
                correo_usuario: {
                    [sequelize_1.Op.like]: correo_usuario // Búsqueda insensible a mayúsculas/minúsculas
                },
...
const verifyEmailCode = async (req, res) => {
    ...
    try {
        const usuario = await Usuario_model_1.default.findOne({ where: { correo_usuario } });
        if (!usuario) {
            return res.status(404).json({ error: 'Usuario no encontrado' });
        }
